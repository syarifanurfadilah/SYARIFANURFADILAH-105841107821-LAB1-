          ...
          <TouchableOpacity
            ...
            style={[
              styles.colorCircle,
              {
                ...
                elevation: selectedColors.includes(color) ? 5 : 0, // Add shadow if selected
              }
            ]}
          ...
          <TouchableOpacity
            ...
            style={[
              styles.sizeButton,
              {
                ...
                elevation: selectedSizes.includes(size) ? 5 : 0, // Add shadow if selected
              }
            ]}
        ...
        {categories.map(category => (
          <TouchableOpacity
            ...
            style={[
              ...
              {
                backgroundColor: selectedCategory === category ? '#28A745' : '#fff',
                elevation: selectedCategory === category ? 5 : 0, // Add shadow if selected
              }
            ]}
        ...
        {brands.map(brand => (
          <TouchableOpacity
            ...
            style={[
              styles.brandButton,
              {
                backgroundColor: selectedBrands.includes(brand) ? '#DC3545' : '#fff',
                elevation: selectedBrands.includes(brand) ? 5 : 0, // Add shadow if selected
              }
            ]}
